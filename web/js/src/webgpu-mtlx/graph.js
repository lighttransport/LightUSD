  ...
  function evaluate(name, out, scope, env) {
    ...
    if (compound) {
      ...
      switch (n.category) {
        ...
        case 'g18_rec709_to_lin_rec709': case 'g22_rec709_to_lin_rec709': case 'rec709_display_to_lin_rec709': case 'g22_ap1_to_lin_rec709': case 'srgb_texture_to_lin_rec709': {
