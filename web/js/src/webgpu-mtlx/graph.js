    ...
    if (compound) {
      ...
      switch (n.category) {
        ...
        case 'standard_surface': case 'open_pbr_surface': {
          ...
          const closure = `closureMix(closureLeaf(${transmittedLobe}),closureLeaf(nativeSubsurface(${subsurfaceColor},1.0,${subsurfaceRadius},0.0)),clamp(${subsurfaceWeight},0.0,1.0))`;
