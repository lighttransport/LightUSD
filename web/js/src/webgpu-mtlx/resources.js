...
export async function loadMaterialXResources(url, options = {}) {
  ...
  for (const node of nodes) {
    if (!['image', 'tiledimage', 'gltf_image', 'gltf_normalmap', 'gltf_colorimage', 'gltf_iridescence_thickness', 'gltf_anisotropy_image', 'triplanarprojection', 'UsdUVTexture', 'usduvtexture', 'latlongimage'].includes(node.category)) continue;
