...
export async function loadMaterialXResources(url, options = {}) {
  ...
  for (const node of nodes) {
    if (!['image', 'tiledimage', 'gltf_image', 'gltf_normalmap', 'gltf_colorimage', 'triplanarprojection', 'UsdUVTexture', 'usduvtexture', 'latlongimage'].includes(node.category)) continue;
