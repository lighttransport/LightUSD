...
try {
  ...
  if(process.argv.includes('--reference-images')) {
    const referencePresets=['native-copper','native-glass','sss','hair','thin-film','subsurface','normalmap','bump','ops','ops-advanced','layered','coat','sheen','thin-walled','transmission-depth','generalized-schlick','open-pbr-weight','open-pbr-film','open-pbr-normal','opacity','displacement','normalmap-image'];
